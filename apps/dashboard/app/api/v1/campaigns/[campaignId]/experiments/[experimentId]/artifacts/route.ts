import { listDashboardArtifacts } from "dark-factory/local-dashboard";
...
export async function GET(request: Request, context: Context): Promise<Response> {
  return withDashboardSession(request, async () => {
    ...
    const artifacts = await listDashboardArtifacts(dashboardStateRoot, campaignId, experimentId);
