...
const ValidationReleaseSchema = Type.Object(
  {
    ...
    onlineErrorBudget: Type.Object(
      {
        policyVersion: Type.Literal("online-alpha-spending-v1"),
        maximumOnlineError: UnitIntervalSchema,
        gateOrdinal: Type.Integer({ minimum: 1 }),
        alphaSpent: UnitIntervalSchema,
        cumulativeSpentBefore: UnitIntervalSchema,
        cumulativeSpentAfter: UnitIntervalSchema,
        remainingAfter: UnitIntervalSchema,
        reservationHash: HashSchema,
        priorStateHash: HashSchema,
        resultingStateHash: HashSchema,
      },
      { additionalProperties: false },
    ),
