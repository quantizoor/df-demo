 ...
 */
export const MVP_MODEL_DEPLOYMENT_ALIAS_PATTERN =
  "^[a-z0-9]+(?:[._-][a-z0-9]+)*$" as const;
export const MVP_MODEL_DEPLOYMENT_ALIAS_MAX_LENGTH = 128 as const;

const MODEL_DEPLOYMENT_ALIAS = new RegExp(
  MVP_MODEL_DEPLOYMENT_ALIAS_PATTERN,
  "u",
);

export function isMvpModelDeploymentAlias(
  value: unknown,
): value is string {
  return (
    typeof value === "string" &&
